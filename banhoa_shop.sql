...
--
-- Host: localhost:3306
-- Generation Time: Mar 20, 2023 at 12:57 AM
...
CREATE TABLE `colors` (
  ...
  `img` varchar(225) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
CREATE TABLE `slides` (
  ...
  `caption` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
